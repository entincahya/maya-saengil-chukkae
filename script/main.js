...
const animationTimeline = () => {
  ...
  tl
    ...
    .staggerFromTo(".message1", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message2", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message3", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message4", {opacity:1}, {opacity:0}, 0.7)
    .staggerFromTo(".message5", {opacity:1}, {opacity:0}, 0.7)
    .staggerFromTo(".message6", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message7", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message8", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message9", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message10", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message11", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message12", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message13", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message14", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message15", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message16", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message17", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message18", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message19", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message20", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message21", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message22", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message23", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message24", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message25", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message26", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message27", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message28", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message29", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message30", {opacity:1}, {opacity:0}, 0.7)    
    .staggerFromTo(".message31", {opacity:1}, {opacity:0}, 0.7)    
    .to(".six", 0.5, {
      opacity: 0,
      y: 30,
      zIndex: "-1"
